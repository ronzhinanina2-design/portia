...
const DEMO_RAW_ITEMS = [
  ...
  { name: 'Pasta', kcal: 130, protein: 4, fat: 1, carbs: 26, tags: ['Garnish', 'Grains', 'Vegetarian'] },
  { name: 'Olives', kcal: 130, protein: 2, fat: 12, carbs: 4, tags: ['Vegetarian'] },
  // Source gave 120 kcal / 14g fat per 1 tbsp (14g) — scaled to per-100g, wholeG keeps "whole" = 1 tbsp.
  { name: 'Olive oil', kcal: 857, protein: 0, fat: 100, carbs: 0, tags: ['Healthy fats', 'Dressing'], wholeG: 14 },
  { name: 'Spinach', kcal: 23, protein: 3, fat: 0, carbs: 4, tags: ['Vegetarian', 'Garnish'] },
  { name: 'Tomatoes', kcal: 24, protein: 1, fat: 0, carbs: 5, tags: ['Vegetarian', 'Lunch', 'Dinner', 'Garnish'] },
  { name: 'Champignons', kcal: 35, protein: 5, fat: 1, carbs: 3, tags: ['Vegetarian', 'Garnish'] },
  ...
  { name: 'Salmon (raw)', kcal: 208, protein: 20, fat: 13, carbs: 0, tags: ['Fish', 'High protein', 'Healthy fats'] },
  { name: 'Asparagus', kcal: 20, protein: 2, fat: 0, carbs: 4, tags: ['Vegetarian', 'Garnish'] },
  { name: 'Turkey mince', kcal: 148, protein: 19, fat: 8, carbs: 0, tags: ['Meat', 'High protein'] },
  { name: 'Cod (raw)', kcal: 82, protein: 18, fat: 1, carbs: 0, tags: ['Fish', 'High protein'] },
  { name: 'Buckwheat', kcal: 110, protein: 4, fat: 1, carbs: 21, tags: ['Grains'] },
  { name: 'Feta cheese', kcal: 264, protein: 14, fat: 21, carbs: 4, tags: ['Dairy', 'Healthy fats'] },
  { name: 'Black coffee', kcal: 2, protein: 0, fat: 0, carbs: 0, tags: ['Drink', 'Breakfast'] },
  { name: 'Mixed vegetables', kcal: 35, protein: 2, fat: 0, carbs: 7, tags: ['Vegetarian', 'Garnish'] },
  { name: 'Tomato sauce', kcal: 29, protein: 1, fat: 0, carbs: 6, tags: ['Garnish'] },
  ...
  { name: 'Kefir', kcal: 41, protein: 3, fat: 1, carbs: 4, tags: ['Dairy', 'Drink'] },
  { name: 'Rice crackers', kcal: 387, protein: 7, fat: 3, carbs: 81, tags: ['Snack', 'Grains'] },
  { name: 'Shrimp (cooked)', kcal: 99, protein: 24, fat: 0, carbs: 0, tags: ['Fish', 'High protein'] },
];
